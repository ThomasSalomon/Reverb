...
export default function AddToListModal({ isOpen, onClose, musicItemId, username }: AddToListModalProps) {
  ...
  return (
    <AccessibleDialog isOpen={isOpen} onClose={onClose} labelledBy="add-to-list-dialog-title" className={styles.overlay}>
      <div className={styles.modal}>
        <div className={styles.header}>
          <h2 id="add-to-list-dialog-title" className={styles.title}>{t("addToListTitle")}</h2>
